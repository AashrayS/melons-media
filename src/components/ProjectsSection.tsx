...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="py-16 md:py-32 px-4 md:px-8 lg:px-16 xl:px-24 bg-gradient-to-br from-[#010100] via-[#111111] to-[#000000] text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          <div className="flex flex-wrap gap-2 justify-center mb-8">
            <span className="px-4 py-2 bg-[#378c35]/20 border border-[#378c35]/30 rounded-full text-sm font-medium">
              Tech Media Strategy
            </span>
            <span className="px-4 py-2 bg-[#fd8d1b]/20 border border-[#fd8d1b]/30 rounded-full text-sm font-medium">
              Brand Growth
            </span>
          </div>
        </div>
              ...
              <div className={`space-y-6 ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                ...
                <div className="space-y-4">
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-[#fd8d1b] text-[#010100] rounded-full text-sm font-bold">
                      {project.category.split(' + ')[0]}
                    </span>
                    {project.category.includes(' + ') && (
                      <span className="px-3 py-1 bg-[#378c35] text-white rounded-full text-sm font-bold">
                ...
                {/* Key Results */}
                <div className="space-y-4">
                  <h4 className="text-xl font-bold text-[#fd8d1b] flex items-center">
                ...
                {/* Technologies */}
                <div className="space-y-4">
                  <h4 className="text-lg font-bold text-white">Technologies & Services</h4>
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech, techIndex) => (
                      <span
                        key={techIndex}
                        className="px-3 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-white/80 text-sm font-medium transition-all duration-300 hover:scale-105"
                      >
                        {tech}
                      </span>
                    ))}
                ...
                <div className="pt-4">
                  <Button 
                    className="bg-transparent border-2 border-[#fd8d1b] text-[#fd8d1b] hover:bg-[#fd8d1b] hover:text-[#010100] font-bold text-lg px-8 py-4 group transition-all duration-300 hover:scale-105"
                  >
              ...
              <div className={`relative ${index % 2 === 1 ? 'lg:col-start-1' : ''}`}>
                ...
                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-gradient-to-br from-[#378c35] to-[#2c8433] shadow-2xl">
                      ...
                      if (parent) {
                        ...
                        parent.innerHTML = `
                          <div class="text-center">
                            ...
                            <h3 class="text-2xl font-bold text-white">${project.title.split(' ')[0]}</h3>
                          </div>
                        `;
                      }
                    }}
                  ...
                  <div className="absolute top-6 right-6">
                    <div className="w-16 h-16 bg-[#fd8d1b] text-[#010100] rounded-full flex items-center justify-center font-bold text-xl shadow-xl">
                      0{project.id}
                    </div>
                  </div>
                ...
                <div className="absolute -bottom-6 -right-6 bg-gradient-to-br from-[#010100]/95 via-[#111111]/95 to-[#000000]/95 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-2xl max-w-xs">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <span className="text-white/70 text-sm font-medium">Live Results</span>
                  </div>
                  
                  <div className="space-y-2">
                    <div className="text-2xl font-bold text-[#fd8d1b]">
        ...
        <div className="text-center mt-24">
          <Link to="/projects">
            <Button 
              className="bg-gradient-to-r from-[#fd8d1b] to-[#fd8e1b] text-[#010100] hover:from-[#fd8e1b] hover:to-[#fd8d1a] font-bold text-xl px-12 py-6 group shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105 rounded-xl"
            >
