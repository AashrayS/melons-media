...
const HeroSection = () => {  return (
    <section id="hero" className="min-h-screen flex flex-col items-center justify-center px-6 bg-black text-white relative overflow-hidden pt-32 md:pt-28">
      {/* Background elements */}
      ...
      <div className="max-w-5xl mx-auto text-center z-10 relative animate-fade-in">        <h1 className="text-6xl md:text-8xl font-light tracking-tight mb-8 leading-tight">
